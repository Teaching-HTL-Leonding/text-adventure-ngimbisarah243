    ...
    while (!quit)
    {
        switch (room)
        {
            ...
            case SHOW_SHADOW_FIGURE:
                ShowShadowFigure(ref room);
                break;
            case CAMERA_SCENE:
                CameraScene(ref room);
                break;
            case HAUNTED_ROOM:
                HauntedRoom(ref room);
                break;
            case SHOW_SKELETONS:
                ShowSkeletons(ref room, ref weapon);
                break;
            case STRANGE_CREATURE:
                StrangeCreature(ref room, ref goulAlive, ref weapon);
                break;
            case EXIT:
                quit = true;
                break;
...
void ShowShadowFigure(ref int room)
{
...
void ShowSkeletons(ref int room, ref bool weapon)
{
...
void StrangeCreature(ref int room,ref bool goulAlive, ref bool weapon)
{
    if (goulAlive)
    {
